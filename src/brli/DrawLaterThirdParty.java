...
public class DrawLaterThirdParty extends Data{
	...
	@Test
	public void addpatientdltp() throws Exception {
		driver.get(baseUrl);
		...
		Thread.sleep(1000);
		driver.findElement(By.id("QuickDxTextbox")).sendKeys("B54");
		Thread.sleep(1000);
		...
		for (int i = 0; i< row.getLastCellNum(); i++) {
			 ...
			 cell.setCellValue("DrawLaterThirdParty"+": " + orderNo + ": "+date1);
		}
		fis.close();
