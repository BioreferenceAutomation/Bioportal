...
public class DrawNowPatient extends Data{
	...
	@Test
	public void addpatientdnpatient() throws Exception {
		driver.get(baseUrl);
		...
		wait17.until(ExpectedConditions.visibilityOfElementLocated(By.name("SubmitComplete")));
		...
		for (int i = 0; i< row.getLastCellNum(); i++) {
			 ...
			 cell.setCellValue("DrawNowPatient"+": " + orderNo + ": "+date1);
		}
		fis.close();
